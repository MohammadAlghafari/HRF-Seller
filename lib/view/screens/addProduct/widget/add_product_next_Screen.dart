...
import '../../../../data/model/response/add_product_model.dart';
import '../../../../data/model/response/attribute_model.dart';
import '../../../../data/model/response/product_model.dart';
import '../../../../data/model/response/variant_type_model.dart';
...
import '../../../base/attribute_view.dart';
                ...
                Column(
                            ...
                            children: [
                              ...
                              Container(
                                ...
                                child: DropdownButton<String>(
                                  hint: _unitValue == null ? Text(getTranslated('select', context,), style: TextStyle(color: Colors.black),)
                  ...
                  AttributeView(product: widget.product, colorOn: resProvider.attributeList[0].active),
                    ...
                    CustomTextField(
                      ...
                      hintText: 'www.youtube.com/example',
